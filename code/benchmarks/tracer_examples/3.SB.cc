...
label_1:;
  ...
  int v2_r3 = vars1.load(__LINE__, memory_order_acquire);
  int v12 = (v2_r3 == 0);
  atom_0_r3_0.store(__LINE__, v12, memory_order_release);
...
label_2:;
  ...
  int v13 = (v4_r3 == 0);
  atom_1_r3_0.store(__LINE__, v13, memory_order_release);
...
label_3:;
  ...
  int v14 = (v6_r3 == 0);
  atom_2_r3_0.store(__LINE__, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atom_0_r3_0.load(__LINE__, memory_order_acquire);
  int v8 = atom_1_r3_0.load(__LINE__, memory_order_acquire);
  int v9 = atom_2_r3_0.load(__LINE__, memory_order_acquire);
  int v10_conj = v8 & v9;
