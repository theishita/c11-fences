...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v14_r10, memory_order_release);
  ...
  int v24 = (v16_r12 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r12_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r12_1, memory_order_acquire);
