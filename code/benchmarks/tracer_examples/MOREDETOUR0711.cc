...
label_2:;
  ...
  int v6_r4 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v17 = (v6_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_3, v17, memory_order_release);
  int v18 = (v4_r1 == 1);
...
void t2(void *arg){
label_3:;
  atomic_store_explicit(__LINE__, __LINE__, &vars[2], 4, memory_order_release);
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
