...
label_2:;
  ...
  int v15_r13 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v12_r12], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v15_r13 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r13_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v17 = (v16 == 2);
  int v18 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r13_0, memory_order_acquire);
