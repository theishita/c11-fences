...
lbl_LC01:;
  ...
  int v8_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
...
lbl_LC02:;
  ...
  int v16 = (v11_r9 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r9_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r9_0, memory_order_acquire);
