...
label_1:;
  ...
  int v13 = (v2_r5 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_1, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_1, memory_order_acquire);
