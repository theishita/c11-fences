...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v6_r3 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v25 = (v4_r1 == 1);
...
void t4(void *arg){
label_5:;
  int v8_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
...
void t5(void *arg){
label_6:;
  int v10_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[4], memory_order_acquire);
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
