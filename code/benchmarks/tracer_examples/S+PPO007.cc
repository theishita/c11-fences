...
lbl_LC00:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v6_r6], 1, memory_order_release);
  int v8_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v9_r10 = v8_r9 ^ v8_r9;
  int v12_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[4+v9_r10], memory_order_acquire);
  int v13_r13 = v12_r11 ^ v12_r11;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v13_r13], 1, memory_order_release);
  int v18 = (v2_r1 == 1);
