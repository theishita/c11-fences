...
label_2:;
  ...
  int v4_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v6_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v18 = (v2_r3 == 0);
  ...
  int v20 = (v6_r7 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v8 = (v7 == 2);
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
