...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2+v5_r5], 1, memory_order_release);
  int v7_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v9_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
