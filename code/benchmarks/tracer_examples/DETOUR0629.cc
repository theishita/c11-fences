...
label_2:;
  ...
  int v8_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v5_r4], memory_order_acquire);
  int v10_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v4_r3 == 2);
  ...
  int v24 = (v10_r7 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v13 = (v12 == 2);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
