...
label_2:;
  ...
  int v6_r5 = v5_r5 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[2], v6_r5, memory_order_release);
  int v8_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v9_r8 = v8_r7 ^ v8_r7;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v9_r8], 1, memory_order_release);
  int v11_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v11_r11 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r11_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r11_1, memory_order_acquire);
