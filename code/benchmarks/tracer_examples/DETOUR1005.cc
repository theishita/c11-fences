...
lbl_LC00:;
  ...
  int v12 = (v2_r5 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_3, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_3, memory_order_acquire);
