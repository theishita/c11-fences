...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v7_r7], 1, memory_order_release);
  int v9_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v10_r11 = v9_r10 ^ v9_r10;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v10_r11], 1, memory_order_release);
  int v18 = (v2_r1 == 1);
