...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v9_r7], 1, memory_order_release);
  ...
  int v19 = (v11_r10 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r10_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
