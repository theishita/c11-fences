...
label_1:;
  ...
  int v11 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v11, memory_order_release);
...
label_2:;
  ...
  int v12 = (v4_r6 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_2, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v7 = (v6 == 3);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
  int v9_conj = v7 & v8;
