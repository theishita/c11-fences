...
label_3:;
  ...
  int v15 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_1, v15, memory_order_release);
  int v16 = (v8_r3 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_1, memory_order_acquire);
