...
label_2:;
  ...
  int v17 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_1, memory_order_acquire);
