...
label_1:;
  ...
  int v14 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_1, v14, memory_order_release);
...
label_2:;
  ...
  int v16 = (v8_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v16, memory_order_release);
