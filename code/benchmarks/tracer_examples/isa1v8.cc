...
label_3:;
  ...
  int v6_r2 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v13 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_2, v13, memory_order_release);
  int v14 = (v6_r2 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r2_0, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_2, memory_order_acquire);
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r2_0, memory_order_acquire);
  int v10_conj = v8 & v9;
