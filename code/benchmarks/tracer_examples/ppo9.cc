...
label_1:;
  ...
  int v8_r2 = atomic_load_explicit(__LINE__, __LINE__, &vars[1+v5_r10], memory_order_acquire);
  int v12 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v12, memory_order_release);
  int v13 = (v8_r2 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r2_0, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r2_0, memory_order_acquire);
  int v11_conj = v9 & v10;
