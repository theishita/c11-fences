...
lbl_LC00:;
  int v8_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v14 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v14, memory_order_release);
  int v15 = (v5_r7 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_2, v15, memory_order_release);
  int v16 = (v8_r8 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r8_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_2, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_0, memory_order_acquire);
