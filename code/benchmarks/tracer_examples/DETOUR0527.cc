...
lbl_LC00:;
  ...
  int v14 = (v4_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v14, memory_order_release);
  int v15 = (v7_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_1, memory_order_acquire);
