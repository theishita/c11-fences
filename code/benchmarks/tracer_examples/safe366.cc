...
label_1:;
  ...
  int v19 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
