...
lbl_LC00:;
  ...
  int v15 = (v5_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_1, v15, memory_order_release);
  int v16 = (v8_r7 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_1, memory_order_acquire);
