...
label_2:;
  ...
  int v20 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_2, v20, memory_order_release);
  int v21 = (v6_r3 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_2, memory_order_acquire);
