...
label_3:;
  ...
  int v12_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v9_r4], memory_order_acquire);
  int v22 = (v8_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_1, v22, memory_order_release);
  int v23 = (v12_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r5_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_1, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r5_0, memory_order_acquire);
