...
label_2:;
  ...
  int v7_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v8_r9 = v7_r8 ^ v7_r8;
  int v11_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v8_r9], memory_order_acquire);
