...
label_2:;
  ...
  int v12_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[2+v9_r5], memory_order_acquire);
  ...
  int v23 = (v8_r4 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_2, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
