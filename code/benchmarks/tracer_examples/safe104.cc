...
label_2:;
  ...
  int v14 = (v2_r1 == 2);
  atom_1_r1_2.store(v14, memory_order_release);
...
label_3:;
  ...
  int v15 = (v4_r3 == 0);
  atom_2_r3_0.store(v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = vars1.load(memory_order_acquire);
  int v8 = (v7 == 2);
  int v9 = atom_1_r1_2.load(memory_order_acquire);
  int v10 = atom_2_r3_0.load(memory_order_acquire);
  int v11_conj = v9 & v10;
