...
lbl_LC00:;
  ...
  int v9_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v6_r6], memory_order_acquire);
  int v11_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v12_r10 = v11_r9 ^ v11_r9;
  int v15_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v12_r10], memory_order_acquire);
  ...
  int v22 = (v17_r13 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r13_0, v22, memory_order_release);
