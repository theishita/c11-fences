...
label_3:;
  ...
  int v17 = (v6_r4 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_1, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_1, memory_order_acquire);
