...
label_4:;
  ...
  int v17 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r3_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r3_0, memory_order_acquire);
