...
lbl_LC00:;
  ...
  int v7_r6 = v6_r6 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[3], v7_r6, memory_order_release);
  ...
  int v13_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v10_r10], memory_order_acquire);
  int v20 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r11_0, memory_order_acquire);
