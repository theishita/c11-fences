...
lbl_LC00:;
  ...
  int v22 = (v7_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_3, memory_order_acquire);
