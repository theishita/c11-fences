...
label_2:;
  ...
  int v8_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v9_r9 = v8_r8 ^ v8_r8;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v9_r9], 1, memory_order_release);
  int v20 = (v2_r1 == 1);
