...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v7_r5], 1, memory_order_release);
  int v17 = (v4_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_2, v17, memory_order_release);
  int v18 = (v6_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_3, v18, memory_order_release);
