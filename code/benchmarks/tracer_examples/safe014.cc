...
label_3:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v5_r3], 1, memory_order_release);
  int v16 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v9 = (v8 == 2);
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_1, memory_order_acquire);
