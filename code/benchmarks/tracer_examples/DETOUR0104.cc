...
lbl_LC00:;
  ...
  int v15 = (v2_r3 == 1);
  atom_0_r3_1.store(__LINE__, v15, memory_order_release);
...
label_2:;
  ...
  int v9_r4;
  if(sum == 0) {
    v9_r4 = vars0.load(__LINE__, memory_order_acquire);
  }
  else if(sum == 1) {
    v9_r4 = vars1.load(__LINE__, memory_order_acquire);
  }

  int v16 = (v5_r1 == 2);
  atom_1_r1_2.store(__LINE__, v16, memory_order_release);
  int v17 = (v9_r4 == 0);
  atom_1_r4_0.store(__LINE__, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atom_0_r3_1.load(__LINE__, memory_order_acquire);
  int v11 = atom_1_r1_2.load(__LINE__, memory_order_acquire);
  int v12 = atom_1_r4_0.load(__LINE__, memory_order_acquire);
