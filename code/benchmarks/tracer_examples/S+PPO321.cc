...
label_2:;
  ...
  int v12_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v9_r9], memory_order_acquire);
  int v13_r12 = v12_r10 ^ v12_r10;
  int v14_r12 = v13_r12 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v14_r12, memory_order_release);
  int v22 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v16 = (v15 == 2);
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v18 = (v17 == 2);
