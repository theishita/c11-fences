...
label_2:;
  ...
  int v16 = (v4_r5 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_1, v16, memory_order_release);
  int v17 = (v6_r6 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_2, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_1, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_2, memory_order_acquire);
