...
label_3:;
  ...
  int v6_r3 = v5_r3 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v6_r3, memory_order_release);
  ...
  int v18 = (v8_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r5_2, v18, memory_order_release);
  int v19 = (v4_r1 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_3, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_3, memory_order_acquire);
