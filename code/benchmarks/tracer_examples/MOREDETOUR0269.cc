...
label_2:;
  ...
  int v23 = (v8_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_2, v23, memory_order_release);
...
void t3(void *arg){
label_4:;
  int v10_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], 2, memory_order_release);
  int v24 = (v10_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
