...
lbl_LC00:;
  ...
  int v5_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v18 = (v7_r7 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_1, memory_order_acquire);
