...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2+v5_r4], 1, memory_order_release);
  ...
  int v11_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v8_r9], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v18, memory_order_release);
  int v19 = (v11_r10 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r10_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r10_0, memory_order_acquire);
