...
label_1:;
  ...
  int v15 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v15, memory_order_release);
...
label_3:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v5_r3], 1, memory_order_release);
  int v16 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v9 = (v8 == 2);
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
