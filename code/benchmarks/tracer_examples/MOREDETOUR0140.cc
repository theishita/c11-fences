...
label_1:;
  ...
  int v4_r3 = v3_r3 + 1;
  vars1.store(__LINE__, v4_r3, memory_order_release);
  int v20 = (v2_r1 == 1);
  atom_0_r1_1.store(__LINE__, v20, memory_order_release);
...
label_2:;
  ...
  vars1.store(__LINE__, 3, memory_order_release);
  int v8_r4 = vars1.load(__LINE__, memory_order_acquire);
  int v9_cmpeq = (v8_r4 == v8_r4);
  if (v9_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  vars0.store(__LINE__, 1, memory_order_release);
  int v21 = (v6_r1 == 1);
  atom_1_r1_1.store(__LINE__, v21, memory_order_release);

}

static void t2(void *arg){
label_3:;
  int v11_r1 = vars1.load(__LINE__, memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atom_0_r1_1.load(__LINE__, memory_order_acquire);
  int v13 = atom_1_r1_1.load(__LINE__, memory_order_acquire);
  int v14 = vars1.load(__LINE__, memory_order_acquire);
  int v15 = (v14 == 3);
  int v16 = atom_2_r1_1.load(__LINE__, memory_order_acquire);
