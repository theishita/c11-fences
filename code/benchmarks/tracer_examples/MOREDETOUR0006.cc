...
lbl_LC00:;
  ...
  int v17 = (v5_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_0, memory_order_acquire);
