...
label_1:;
  ...
  int v14 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v14, memory_order_release);
...
label_2:;
  ...
  int v10_r4 = v9_r4 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v10_r4, memory_order_release);
