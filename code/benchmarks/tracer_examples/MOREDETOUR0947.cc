...
label_3:;
  ...
  int v14 = (v4_r4 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_4, v14, memory_order_release);
  int v15 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_2, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 5);
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_4, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_2, memory_order_acquire);
  int v11_conj = v9 & v10;
