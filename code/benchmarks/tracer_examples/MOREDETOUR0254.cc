...
label_1:;
  ...
  int v18 = (v2_r1 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_4, v18, memory_order_release);
...
void t2(void *arg){
label_3:;
  int v9_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_4, memory_order_acquire);
