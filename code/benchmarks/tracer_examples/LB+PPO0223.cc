...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2+v9_r4], 1, memory_order_release);
  int v11_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v12_r8 = v11_r7 ^ v11_r7;
  int v15_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v12_r8], memory_order_acquire);
