...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v10_r10], 1, memory_order_release);
  int v12_r13 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v19, memory_order_release);
  int v20 = (v12_r13 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r13_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r13_1, memory_order_acquire);
