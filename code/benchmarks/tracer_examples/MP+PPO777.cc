...
label_2:;
  ...
  int v20 = (v12_r10 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r10_1, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
