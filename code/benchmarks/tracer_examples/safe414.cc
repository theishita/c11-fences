...
label_1:;
  ...
  int v8 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_1, v8, memory_order_release);
  int v9 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v9, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_1, memory_order_acquire);
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
  int v7_conj = v5 & v6;
