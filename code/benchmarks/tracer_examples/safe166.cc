...
label_1:;
  ...
  int v18 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v18, memory_order_release);
  int v19 = (v4_r3 == 0);
...
label_2:;
  ...
  int v20 = (v6_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v20, memory_order_release);
