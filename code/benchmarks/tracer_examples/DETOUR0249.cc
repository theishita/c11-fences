...
label_2:;
  ...
  int v14_r7 = v13_r7 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v14_r7, memory_order_release);
  int v21 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
