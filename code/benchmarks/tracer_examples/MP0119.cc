...
label_2:;
  ...
  int v9_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v16 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v16, memory_order_release);
  int v17 = (v9_r9 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r9_1, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r9_1, memory_order_acquire);
