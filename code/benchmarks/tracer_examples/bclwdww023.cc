...
label_4:;
  ...
  int v24 = (v10_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r3_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r3_1, memory_order_acquire);
