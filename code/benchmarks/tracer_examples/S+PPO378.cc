...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v11_r8], 1, memory_order_release);
  int v13_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v14_r12 = v13_r11 ^ v13_r11;
  int v15_r12 = v14_r12 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v15_r12, memory_order_release);
  int v20 = (v2_r1 == 1);
