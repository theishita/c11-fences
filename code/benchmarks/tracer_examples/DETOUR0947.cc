...
label_2:;
  ...
  int v6_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v3_r4], memory_order_acquire);
  ...
  int v19 = (v8_r7 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_1, v19, memory_order_release);
