...
void t3(void *arg){
label_4:;
  int v2_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  atomic_store_explicit(__LINE__, __LINE__, &vars[4], 1, memory_order_release);
  int v4_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[4], memory_order_acquire);
  ...
  int v19 = (v8_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r7_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r7_0, memory_order_acquire);
