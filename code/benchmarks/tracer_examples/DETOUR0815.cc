...
label_2:;
  ...
  int v7_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v16 = (v2_r1 == 1);
  ...
  int v18 = (v7_r8 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r8_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_1, memory_order_acquire);
