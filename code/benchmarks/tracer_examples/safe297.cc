...
label_1:;
  ...
  int v20 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v20, memory_order_release);
...
label_3:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v7_r3], 1, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = (v10 == 2);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
