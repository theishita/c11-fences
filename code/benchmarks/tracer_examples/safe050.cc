...
label_1:;
  ...
  int v17 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_1, v17, memory_order_release);
...
label_2:;
  ...
  int v18 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_2, v18, memory_order_release);
