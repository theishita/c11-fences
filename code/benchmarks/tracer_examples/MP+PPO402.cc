...
lbl_LC00:;
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v13_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v13_r10 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r10_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v15 = (v14 == 2);
