...
label_2:;
  ...
  int v10_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v11_r7 = v10_r6 ^ v10_r6;
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v11_r7], 1, memory_order_release);
