...
void t2(void *arg){
label_3:;
  int v8_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v9_r3 = v8_r1 ^ v8_r1;
  int v12_r4 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v9_r3], memory_order_acquire);
  int v22 = (v8_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_1, v22, memory_order_release);
  int v23 = (v12_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_0, v23, memory_order_release);
