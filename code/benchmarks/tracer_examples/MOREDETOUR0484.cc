...
lbl_LC00:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2], 3, memory_order_release);
  int v5_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v16 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v16, memory_order_release);
  int v17 = (v5_r6 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
