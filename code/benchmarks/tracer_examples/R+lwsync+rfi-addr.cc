...
label_2:;
  ...
  int v13 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_2, v13, memory_order_release);
  int v14 = (v6_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_0, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
