...
label_1:;
  ...
  int v22 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v22, memory_order_release);
...
label_3:;
  ...
  int v10_r4 = atomic_load_explicit(__LINE__, __LINE__, &vars[2+v7_r3], memory_order_acquire);
  int v23 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_2, v23, memory_order_release);
  int v24 = (v10_r4 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_2, memory_order_acquire);
