...
label_2:;
  ...
  int v20 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v20, memory_order_release);
...
label_4:;
  ...
  int v8_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_1, v21, memory_order_release);
  int v22 = (v8_r5 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r5_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r5_1, memory_order_acquire);
