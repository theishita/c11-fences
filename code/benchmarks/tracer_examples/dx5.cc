...
label_1:;
  ...
  int v12 = (v2_r2 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r2_2, v12, memory_order_release);
...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[1+v5_r9], 1, memory_order_release);
  int v13 = (v4_r2 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r2_1, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r2_2, memory_order_acquire);
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r2_1, memory_order_acquire);
