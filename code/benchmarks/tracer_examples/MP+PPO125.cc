...
lbl_LC00:;
  ...
  int v15_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v12_r11], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v19, memory_order_release);
  int v20 = (v15_r12 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r12_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r12_0, memory_order_acquire);
