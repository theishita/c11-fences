...
label_2:;
  ...
  int v15_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[4+v12_r11], memory_order_acquire);
  int v16_r14 = v15_r12 ^ v15_r12;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v16_r14], 1, memory_order_release);
  int v21 = (v2_r1 == 1);
