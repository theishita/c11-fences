...
label_1:;
  ...
  int v15 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v15, memory_order_release);
...
label_2:;
  ...
  int v8_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v5_r5], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_0, memory_order_acquire);
