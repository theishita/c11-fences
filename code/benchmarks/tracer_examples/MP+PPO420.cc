...
label_2:;
  ...
  int v4_r3 = vars1.load(memory_order_acquire);
  int v5_cmpeq = (v4_r3 == v4_r3);
  if (v5_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  vars2.store(1, memory_order_release);
  int v7_r6 = vars2.load(memory_order_acquire);
  vars2.store(2, memory_order_release);
  int v9_r8 = vars2.load(memory_order_acquire);
  int v10_cmpeq = (v9_r8 == v9_r8);
  if (v10_cmpeq)  goto lbl_LC01; else goto lbl_LC01;
lbl_LC01:;
  atomic_fetch_add_explicit(&__fence_var, 0, memory_order_acq_rel);
  int v12_r9 = vars0.load(memory_order_acquire);
  int v19 = (v2_r1 == 1);
  atom_1_r1_1.store(v19, memory_order_release);
  int v20 = (v12_r9 == 0);
  atom_1_r9_0.store(v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = vars2.load(memory_order_acquire);
  int v14 = (v13 == 2);
  int v15 = atom_1_r1_1.load(memory_order_acquire);
  int v16 = atom_1_r9_0.load(memory_order_acquire);
