...
label_1:;
  ...
  int v9 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_1, v9, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_1, memory_order_acquire);
