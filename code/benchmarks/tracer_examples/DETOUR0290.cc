...
label_1:;
  ...
  int v10 = (v2_r1 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_3, v10, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
