...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v11_r11, memory_order_release);
  int v13_r13 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v23, memory_order_release);
  int v24 = (v13_r13 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r13_1, v24, memory_order_release);
