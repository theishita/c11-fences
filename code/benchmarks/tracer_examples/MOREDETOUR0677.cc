...
label_1:;
  ...
  int v15 = (v2_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r4_0, v15, memory_order_release);
...
label_2:;
  ...
  int v16 = (v4_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_2, v16, memory_order_release);
...
label_3:;
  ...
  int v17 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 3);
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r4_0, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
