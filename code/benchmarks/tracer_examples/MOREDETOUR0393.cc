...
label_2:;
  ...
  int v4_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v17 = (v4_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_0, v17, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v8_r4 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v18 = (v8_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_3, v18, memory_order_release);
  int v19 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
