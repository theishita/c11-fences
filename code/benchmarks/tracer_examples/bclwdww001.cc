...
label_4:;
  int v5_r1 = vars3.load(__LINE__, memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = vars2.load(__LINE__, memory_order_acquire);
  int v10 = (v9 == 2);
  int v11 = atom_1_r1_1.load(__LINE__, memory_order_acquire);
  int v12 = atom_3_r1_1.load(__LINE__, memory_order_acquire);
