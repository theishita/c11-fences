...
label_2:;
  ...
  int v10_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v7_r6], memory_order_acquire);
  int v11_r9 = v10_r7 ^ v10_r7;
  atomic_store_explicit(__LINE__, __LINE__, &vars[4+v11_r9], 1, memory_order_release);
