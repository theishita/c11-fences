...
label_2:;
  ...
  int v17 = (v4_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v17, memory_order_release);
  int v18 = (v6_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v18, memory_order_release);
