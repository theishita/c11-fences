...
label_1:;
  ...
  int v6_r6 = v5_r6 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[1], v6_r6, memory_order_release);
  int v17 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_2, v17, memory_order_release);
  int v18 = (v4_r5 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_3, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_3, memory_order_acquire);
