...
label_2:;
  ...
  int v24 = (v6_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_1, memory_order_acquire);
