...
lbl_LC00:;
  ...
  int v13 = (v4_r4 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_2, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
  int v10_conj = v8 & v9;
