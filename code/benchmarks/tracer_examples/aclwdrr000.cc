...
label_4:;
  ...
  int v14 = (v2_r1 == 2);
  atom_3_r1_2.store(__LINE__, v14, memory_order_release);
  int v15 = (v4_r3 == 0);
  atom_3_r3_0.store(__LINE__, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atom_3_r1_2.load(__LINE__, memory_order_acquire);
  int v10 = atom_3_r3_0.load(__LINE__, memory_order_acquire);
  int v11_conj = v9 & v10;
