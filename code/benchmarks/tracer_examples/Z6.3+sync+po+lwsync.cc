...
label_3:;
  ...
  int v11 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_1, v11, memory_order_release);
  int v12 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_1, memory_order_acquire);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
  int v9_conj = v7 & v8;
