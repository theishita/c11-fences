...
label_1:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[1+v3_r3], 1, memory_order_release);
  int v23 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v23, memory_order_release);

}

void t1(void *arg){
label_2:;
  int v5_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v7_r3 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v24 = (v5_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v24, memory_order_release);
  int v25 = (v7_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = (v12 == 2);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_1, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
