...
lbl_LC00:;
  ...
  int v13_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v15_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
