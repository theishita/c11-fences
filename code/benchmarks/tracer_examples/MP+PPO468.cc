...
lbl_LC00:;
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v13_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v17 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v17, memory_order_release);
  int v18 = (v13_r8 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r8_0, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_0, memory_order_acquire);
