...
label_2:;
  ...
  int v14_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v11_r9], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v20 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r13_1, memory_order_acquire);
