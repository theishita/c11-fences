...
label_3:;
  ...
  int v16 = (v8_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_0, memory_order_acquire);
