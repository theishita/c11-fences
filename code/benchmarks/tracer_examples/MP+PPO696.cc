...
label_2:;
  ...
  int v12_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v9_r8], memory_order_acquire);
...
lbl_LC00:;
  ...
  int v15_r13 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v15_r13 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r13_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v17 = (v16 == 2);
  int v18 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r13_1, memory_order_acquire);
