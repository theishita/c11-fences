...
label_1:;
  ...
  int v19 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_2, v19, memory_order_release);
...
label_2:;
  ...
  int v6_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v20 = (v4_r4 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_4, v20, memory_order_release);
  int v21 = (v6_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_4, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
