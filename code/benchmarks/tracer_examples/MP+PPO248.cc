...
label_2:;
  ...
  int v6_r4 = v5_r4 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[2], v6_r4, memory_order_release);
...
lbl_LC00:;
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v15_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v15_r11 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r11_0, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r11_0, memory_order_acquire);
