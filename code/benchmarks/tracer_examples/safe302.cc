...
label_1:;
  ...
  int v20 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v20, memory_order_release);
...
label_4:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v9_r3], 1, memory_order_release);
