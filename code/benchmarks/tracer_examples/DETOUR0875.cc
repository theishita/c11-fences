...
lbl_LC00:;
  ...
  int v18 = (v7_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_2, memory_order_acquire);
