...
label_2:;
  ...
  int v14_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v11_r9], memory_order_acquire);
  int v15_r12 = v14_r10 ^ v14_r10;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v15_r12], 1, memory_order_release);
  int v20 = (v2_r1 == 1);
