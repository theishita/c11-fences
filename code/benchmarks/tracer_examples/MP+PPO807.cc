...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v6_r7], 1, memory_order_release);
  int v8_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v9_r11 = v8_r10 ^ v8_r10;
  int v12_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v9_r11], memory_order_acquire);
  int v14_r14 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v18, memory_order_release);
  int v19 = (v14_r14 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r14_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
