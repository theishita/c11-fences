...
lbl_LC00:;
  ...
  int v11_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v8_r7], memory_order_acquire);
  int v12_r10 = v11_r8 ^ v11_r8;
  int v13_r10 = v12_r10 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v13_r10, memory_order_release);
  int v15_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v15_r12 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r12_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r12_1, memory_order_acquire);
