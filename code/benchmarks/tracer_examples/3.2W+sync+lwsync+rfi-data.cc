...
label_3:;
  ...
  int v4_r4 = v3_r4 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v4_r4, memory_order_release);
  int v15 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_2, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
