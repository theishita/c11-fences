...
label_4:;
  ...
  int v6_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[4], memory_order_acquire);
  int v7_r6 = v6_r5 ^ v6_r5;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v7_r6], 1, memory_order_release);
  int v18 = (v4_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_1, v18, memory_order_release);
