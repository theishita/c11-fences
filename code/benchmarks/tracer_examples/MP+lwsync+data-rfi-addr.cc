...
label_2:;
  ...
  int v17 = (v6_r5 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_1, v17, memory_order_release);
  int v18 = (v10_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_0, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_1, memory_order_acquire);
