...
lbl_LC00:;
  ...
  int v16 = (v5_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v16, memory_order_release);
  int v17 = (v9_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_0, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
