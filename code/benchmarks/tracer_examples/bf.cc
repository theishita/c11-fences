...
label_2:;
  int v2_r2 = vars0.load(memory_order_acquire);
  int v4_r2 = vars1.load(memory_order_acquire);
  int v8 = (v2_r2 == 0);
  atom_1_r1_0.store(v8, memory_order_release);
  int v9 = (v4_r2 == 1);
  atom_1_r2_1.store( v9, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atom_1_r1_0.load(memory_order_acquire);
  int v6 = atom_1_r2_1.load(memory_order_acquire);
  int v7_conj = v5 & v6;
