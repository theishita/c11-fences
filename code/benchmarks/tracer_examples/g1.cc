...
label_2:;
  ...
  int v7 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v7, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v3 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_0, memory_order_acquire);
