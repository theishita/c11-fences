...
lbl_LC00:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v10_r9], 1, memory_order_release);
  int v12_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v14_r13 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v14_r13 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r13_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r13_1, memory_order_acquire);
