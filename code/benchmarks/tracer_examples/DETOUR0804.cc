...
label_2:;
  ...
  int v8_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v19 = (v2_r1 == 1);
  ...
  int v21 = (v6_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_1, v21, memory_order_release);
  int v22 = (v8_r7 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_2, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_2, memory_order_acquire);
