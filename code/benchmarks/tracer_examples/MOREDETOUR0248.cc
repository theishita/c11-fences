...
label_1:;
  ...
  int v20 = (v2_r1 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_3, v20, memory_order_release);
...
void t2(void *arg){
label_3:;
  int v11_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_3, memory_order_acquire);
