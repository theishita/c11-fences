...
label_4:;
  ...
  int v19 = (v8_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r4_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r4_0, memory_order_acquire);
