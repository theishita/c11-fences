...
label_1:;
  ...
  int v17 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v17, memory_order_release);
...
lbl_LC00:;
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v9_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v18 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v18, memory_order_release);
  int v19 = (v6_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_1, v19, memory_order_release);
  int v20 = (v9_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_0, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_1, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
