...
lbl_LC00:;
  ...
  int v7_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v8_r8 = v7_r7 ^ v7_r7;
  int v11_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v8_r8], memory_order_acquire);
  int v12_r11 = v11_r9 ^ v11_r9;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v12_r11], 1, memory_order_release);
  int v20 = (v2_r1 == 1);
