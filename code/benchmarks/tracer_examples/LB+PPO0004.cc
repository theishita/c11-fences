...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v10_r7], 1, memory_order_release);
  int v12_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v13_r11 = v12_r10 ^ v12_r10;
  int v16_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[4+v13_r11], memory_order_acquire);
