...
lbl_LC00:;
  int v9_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v17 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v17, memory_order_release);
  int v18 = (v4_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v18, memory_order_release);
  int v19 = (v6_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v19, memory_order_release);
  int v20 = (v9_r6 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_1, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
