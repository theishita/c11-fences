...
label_4:;
  ...
  int v25 = (v8_r1 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_3, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
  ...
  int v15 = (v14 == 5);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r1_3, memory_order_acquire);
