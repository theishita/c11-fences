...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v11_r9], 1, memory_order_release);
  int v13_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v20, memory_order_release);
  int v21 = (v13_r12 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r12_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r12_1, memory_order_acquire);
