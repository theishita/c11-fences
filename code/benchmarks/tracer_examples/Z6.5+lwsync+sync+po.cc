...
label_3:;
  ...
  int v10 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v10, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
  int v8_conj = v6 & v7;
