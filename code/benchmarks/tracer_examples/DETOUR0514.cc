...
label_2:;
  ...
  int v6_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v7_r7 = v6_r6 ^ v6_r6;
  int v10_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v7_r7], memory_order_acquire);
  int v19 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v19, memory_order_release);
  int v20 = (v6_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_1, v20, memory_order_release);
  int v21 = (v10_r8 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r8_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_0, memory_order_acquire);
