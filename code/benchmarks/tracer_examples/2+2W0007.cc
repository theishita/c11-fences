...
label_2:;
  ...
  int v2_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v3_r7 = v2_r5 ^ v2_r5;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v3_r7], 1, memory_order_release);
