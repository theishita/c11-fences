...
label_1:;
  ...
  int v19 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v19, memory_order_release);
...
label_3:;
  ...
  int v20 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_1, v20, memory_order_release);
  int v21 = (v10_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_1, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_0, memory_order_acquire);
