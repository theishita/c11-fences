...
label_2:;
  ...
  int v5_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v12 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v12, memory_order_release);
  int v13 = (v5_r8 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r8_2, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_2, memory_order_acquire);
  int v10_conj = v8 & v9;
