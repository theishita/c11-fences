...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2+v11_r6], 1, memory_order_release);
  int v13_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
