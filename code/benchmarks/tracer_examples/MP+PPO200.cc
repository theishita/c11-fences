...
label_2:;
  ...
  int v10_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v12_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v13_r11 = v12_r10 ^ v12_r10;
  int v16_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v13_r11], memory_order_acquire);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v23, memory_order_release);
  int v24 = (v16_r12 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r12_0, v24, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v18 = (v17 == 2);
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v20 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r12_0, memory_order_acquire);
