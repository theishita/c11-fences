...
lbl_LC00:;
  ...
  int v9_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v6_r5], memory_order_acquire);
  int v11_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v20 = (v2_r1 == 1);
  ...
  int v22 = (v11_r8 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r8_1, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_0, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r8_1, memory_order_acquire);
