...
label_2:;
  ...
  int v16_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[4+v13_r10], memory_order_acquire);
  int v17_r13 = v16_r11 ^ v16_r11;
  int v18_r13 = v17_r13 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], v18_r13, memory_order_release);
  int v23 = (v2_r1 == 1);
