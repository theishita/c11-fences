...
label_1:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v3_r7], 1, memory_order_release);
...
label_2:;
  ...
  int v10 = (v5_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v10, memory_order_release);
