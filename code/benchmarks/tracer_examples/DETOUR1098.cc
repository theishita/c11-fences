...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v5_r5], 1, memory_order_release);
  int v12 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v12, memory_order_release);
  int v13 = (v4_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_3, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_3, memory_order_acquire);
  int v10_conj = v8 & v9;
