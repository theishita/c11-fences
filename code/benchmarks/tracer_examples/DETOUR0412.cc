...
label_1:;
  ...
  int v16 = (v2_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r4_3, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r4_3, memory_order_acquire);
