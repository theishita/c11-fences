...
label_1:;
  ...
  int v11 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_2, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_2, memory_order_acquire);
