...
label_1:;
  ...
  int v21 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v21, memory_order_release);
...
lbl_LC00:;
  int v7_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v4_r4 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_4, v22, memory_order_release);
  int v23 = (v7_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_0, v23, memory_order_release);
...
label_3:;
  ...
  int v24 = (v11_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_3, v24, memory_order_release);
  int v25 = (v9_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_0, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_4, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r1_1, memory_order_acquire);
