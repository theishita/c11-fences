...
lbl_LC00:;
  ...
  int v15_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v12_r7], memory_order_acquire);
  int v17_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
