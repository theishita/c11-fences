...
lbl_LC00:;
  ...
  int v9_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v6_r6], memory_order_acquire);
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], 1, memory_order_release);
  int v11_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v21 = (v13_r11 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r11_1, v21, memory_order_release);
