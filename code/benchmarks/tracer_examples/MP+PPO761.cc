...
lbl_LC00:;
  ...
  int v19 = (v11_r9 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r9_1, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r9_1, memory_order_acquire);
