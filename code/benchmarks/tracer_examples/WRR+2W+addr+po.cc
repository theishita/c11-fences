...
label_2:;
  ...
  int v13 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_2, v13, memory_order_release);
  int v14 = (v6_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_0, v14, memory_order_release);
