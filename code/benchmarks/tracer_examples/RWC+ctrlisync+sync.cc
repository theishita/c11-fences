...
lbl_LC00:;
  ...
  int v5_r3 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v13 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v13, memory_order_release);
  int v14 = (v5_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v14, memory_order_release);
