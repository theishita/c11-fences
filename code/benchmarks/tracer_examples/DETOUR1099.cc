...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v5_r6], 1, memory_order_release);
  int v12 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v12, memory_order_release);
  int v13 = (v4_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v13, memory_order_release);
