...
label_1:;
  ...
  int v21 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_1, memory_order_acquire);
