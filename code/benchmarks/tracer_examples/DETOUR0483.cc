...
label_2:;
  ...
  int v15 = (v8_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v15, memory_order_release);
  int v16 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_2, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
