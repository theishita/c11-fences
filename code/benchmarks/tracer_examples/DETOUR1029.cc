...
lbl_LC00:;
  ...
  int v12 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_1, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 3);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r3_1, memory_order_acquire);
