...
lbl_LC00:;
  ...
  int v11_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v12_r7 = v11_r6 ^ v11_r6;
  int v13_r7 = v12_r7 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[3], v13_r7, memory_order_release);
