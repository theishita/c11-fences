...
label_2:;
  ...
  int v8_r4 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v9_r6 = v8_r4 ^ v8_r4;
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v9_r6], 1, memory_order_release);
  int v21 = (v6_r1 == 1);
