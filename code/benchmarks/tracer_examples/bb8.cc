...
label_2:;
  ...
  int v11 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v11, memory_order_release);
  int v12 = (v4_r2 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r2_0, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_1, memory_order_acquire);
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r2_0, memory_order_acquire);
