...
label_3:;
  ...
  int v16 = (v6_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_3, v16, memory_order_release);
  int v17 = (v4_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
