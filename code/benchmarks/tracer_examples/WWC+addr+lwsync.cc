...
label_2:;
  ...
  int v12 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_2, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_2, memory_order_acquire);
