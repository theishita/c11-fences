...
label_1:;
  ...
  int v12 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_2, v12, memory_order_release);
...
label_2:;
  ...
  int v13 = (v4_r3 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_3, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_2, memory_order_acquire);
