...
label_2:;
  ...
  int v22 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_2, v22, memory_order_release);
  int v23 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v23, memory_order_release);
...
label_4:;
  ...
  int v24 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_2, v24, memory_order_release);
  int v25 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r3_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r1_2, memory_order_acquire);
