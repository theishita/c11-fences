...
label_2:;
  ...
  int v12_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v13_r7 = v12_r6 ^ v12_r6;
  int v16_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[2+v13_r7], memory_order_acquire);
