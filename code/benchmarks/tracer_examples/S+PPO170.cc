...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v11_r10], 1, memory_order_release);
  int v19 = (v2_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v13 = (v12 == 2);
