...
label_2:;
  ...
  int v16 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_2, v16, memory_order_release);
  int v17 = (v6_r3 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r1_2, memory_order_acquire);
