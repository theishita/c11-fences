...
label_2:;
  ...
  int v2_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
...
lbl_LC00:;
  ...
  int v12 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v12, memory_order_release);
  int v13 = (v5_r6 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_0, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
