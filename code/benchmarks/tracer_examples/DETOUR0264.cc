...
lbl_LC00:;
  ...
  int v17 = (v8_r4 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_2, v17, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
