...
label_1:;
  ...
  int v18 = (v6_r6 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r6_0, v18, memory_order_release);
...
label_2:;
  ...
  int v20 = (v12_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r6_0, memory_order_acquire);
