...
label_1:;
  ...
  int v12 = (v2_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r4_3, v12, memory_order_release);
...
label_3:;
  ...
  int v13 = (v5_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v13, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r4_3, memory_order_acquire);
