...
label_2:;
  ...
  int v9_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v10_r8 = v9_r7 ^ v9_r7;
  int v11_r8 = v10_r8 + 1;
  atomic_store_explicit(__LINE__, __LINE__, &vars[3], v11_r8, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v13 = (v12 == 2);
