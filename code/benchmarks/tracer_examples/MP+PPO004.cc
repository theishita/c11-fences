...
label_2:;
  ...
  int v17_r14 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v14_r13], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v17_r14 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r14_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r14_0, memory_order_acquire);
