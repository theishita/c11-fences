...
label_1:;
  ...
  int v16 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_2, v16, memory_order_release);
...
label_2:;
  ...
  int v17 = (v4_r3 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_3, v17, memory_order_release);
  int v18 = (v6_r4 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_4, v18, memory_order_release);
  int v19 = (v8_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_0, v19, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_3, memory_order_acquire);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_4, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_0, memory_order_acquire);
