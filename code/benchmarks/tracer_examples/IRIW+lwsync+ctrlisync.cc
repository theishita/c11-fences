...
lbl_LC00:;
  ...
  int v19 = (v6_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_1, v19, memory_order_release);
  int v20 = (v9_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r3_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r1_1, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r3_0, memory_order_acquire);
