...
lbl_LC00:;
  ...
  int v7_r7 = vars0.load(__LINE__, memory_order_acquire);
  int v14 = (v2_r1 == 1);
  atom_1_r1_1.store(__LINE__, v14, memory_order_release);
  int v15 = (v7_r7 == 1);
  atom_1_r7_1.store(__LINE__, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = vars0.load(__LINE__, memory_order_acquire);
  int v9 = (v8 == 2);
  int v10 = atom_1_r1_1.load(__LINE__, memory_order_acquire);
  int v11 = atom_1_r7_1.load(__LINE__, memory_order_acquire);
