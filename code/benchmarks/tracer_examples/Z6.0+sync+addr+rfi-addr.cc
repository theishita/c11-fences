...
label_3:;
  ...
  int v9_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v6_r4], memory_order_acquire);
  int v19 = (v5_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_2, v19, memory_order_release);
  int v20 = (v9_r5 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r5_0, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_2, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r5_0, memory_order_acquire);
