...
label_2:;
  ...
  int v6_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v7_r6 = v6_r5 ^ v6_r5;
  int v10_r7 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v7_r6], memory_order_acquire);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v18, memory_order_release);
  int v19 = (v4_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_1, v19, memory_order_release);
  int v20 = (v6_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_2, v20, memory_order_release);
  int v21 = (v10_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_0, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_1, memory_order_acquire);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_2, memory_order_acquire);
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
