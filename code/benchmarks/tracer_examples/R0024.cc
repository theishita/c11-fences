...
label_2:;
  ...
  int v12 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_1, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r6_1, memory_order_acquire);
  int v10_conj = v8 & v9;
