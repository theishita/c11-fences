...
label_1:;
  ...
  int v20 = (v4_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_1, v20, memory_order_release);
...
label_3:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2+v7_r3], 1, memory_order_release);
  int v21 = (v6_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v9 = (v8 == 2);
