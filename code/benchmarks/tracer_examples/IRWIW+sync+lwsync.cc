...
label_4:;
  ...
  int v15 = (v4_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_3_r1_2, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_3_r1_2, memory_order_acquire);
  int v11_conj = v9 & v10;
