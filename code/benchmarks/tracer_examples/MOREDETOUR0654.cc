...
label_1:;
  ...
  int v18 = (v2_r3 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_1, v18, memory_order_release);
...
label_3:;
  ...
  int v20 = (v6_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v20, memory_order_release);
