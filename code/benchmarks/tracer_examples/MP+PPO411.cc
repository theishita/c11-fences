...
label_2:;
  ...
  int v14_r11 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v15_cmpeq = (v14_r11 == v14_r11);
  if (v15_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v17_r12 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v21, memory_order_release);
  int v22 = (v17_r12 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r12_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r12_0, memory_order_acquire);
