...
label_2:;
  ...
  int v22 = (v4_r5 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_4, v22, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v10_r4 = atomic_load_explicit(__LINE__, __LINE__, &vars[1], memory_order_acquire);
  int v23 = (v10_r4 == 3);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
