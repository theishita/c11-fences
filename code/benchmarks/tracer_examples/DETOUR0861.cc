...
label_1:;
  ...
  int v13 = (v2_r5 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_2, v13, memory_order_release);
...
lbl_LC00:;
  ...
  int v14 = (v4_r3 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_3, v14, memory_order_release);
  int v15 = (v7_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_0, v15, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_3, memory_order_acquire);
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_0, memory_order_acquire);
  int v11_conj = v9 & v10;
