...
label_2:;
  ...
  int v15 = (v4_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_3, v15, memory_order_release);
  int v16 = (v8_r6 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r6_0, v16, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_3, memory_order_acquire);
