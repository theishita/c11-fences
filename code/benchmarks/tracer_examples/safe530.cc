...
label_1:;
  ...
  int v22 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v22, memory_order_release);
  int v23 = (v4_r3 == 0);
...
label_3:;
  ...
  int v24 = (v6_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r1_2, v24, memory_order_release);
  int v25 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v25, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
  ...
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
