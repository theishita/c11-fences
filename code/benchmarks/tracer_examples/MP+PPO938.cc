...
lbl_LC00:;
  ...
  int v11_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  ...
  int v21 = (v13_r10 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r10_1, v21, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
