...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[3+v9_r7], 1, memory_order_release);
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[0+v14_r12], 1, memory_order_release);
  int v19 = (v2_r1 == 1);
