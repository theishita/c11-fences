...
label_1:;
  ...
  int v19 = (v2_r5 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r5_4, v19, memory_order_release);
...
label_3:;
  ...
  int v22 = (v8_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r3_0, v22, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = (v9 == 2);
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r5_4, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_3, memory_order_acquire);
