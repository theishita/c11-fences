...
label_2:;
  ...
  int v24 = (v8_r5 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_4, v24, memory_order_release);
...
label_3:;
  ...
  int v25 = (v12_r4 == 3);
  atomic_store_explicit(__LINE__, __LINE__, &atom_2_r4_3, v25, memory_order_release);
  int v26 = (v10_r1 == 1);
...
int user_main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r4_3, memory_order_acquire);
