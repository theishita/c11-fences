...
label_1:;
  ...
  int v8 = (v2_r3 == 0);
  atom_0_r3_0.store(__LINE__, v8, memory_order_release);
...
label_2:;
  ...
  int v9 = (v4_r3 == 0);
  atom_1_r3_0.store(__LINE__, v9, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v5 = atom_0_r3_0.load(__LINE__, memory_order_acquire);
  int v6 = atom_1_r3_0.load(__LINE__, memory_order_acquire);
  int v7_conj = v5 & v6;
