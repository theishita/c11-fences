...
label_2:;
  ...
  atomic_store_explicit(__LINE__, __LINE__, &vars[2+v9_r5], 1, memory_order_release);
  ...
  int v20 = (v8_r4 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_2, v20, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r4_2, memory_order_acquire);
