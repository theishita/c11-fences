...
label_2:;
  ...
  int v11_r8 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  int v12_r9 = v11_r8 ^ v11_r8;
  int v15_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[3+v12_r9], memory_order_acquire);
