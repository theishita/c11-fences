...
label_2:;
  ...
  int v11 = (v2_r3 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_2, v11, memory_order_release);
  int v12 = (v4_r4 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r4_0, v12, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_2, memory_order_acquire);
