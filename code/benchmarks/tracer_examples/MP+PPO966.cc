...
label_2:;
  ...
  int v8_r6 = atomic_load_explicit(__LINE__, __LINE__, &vars[0+v5_r5], memory_order_acquire);
  atomic_store_explicit(__LINE__, __LINE__, &vars[0], 1, memory_order_release);
  int v10_r9 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v12_r10 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r1_1, v22, memory_order_release);
  int v23 = (v12_r10 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r10_1, v23, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v18 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r10_1, memory_order_acquire);
