...
label_1:;
  ...
  int v11 = (v2_r1 == 2);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r1_2, v11, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r1_2, memory_order_acquire);
