...
label_1:;
  ...
  int v13 = (v2_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r3_0, v13, memory_order_release);
...
label_2:;
  ...
  int v6_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
...
lbl_LC00:;
  ...
  int v14 = (v9_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_0, v14, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r7_0, memory_order_acquire);
