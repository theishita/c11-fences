...
label_2:;
  ...
  int v4_r5 = atomic_load_explicit(__LINE__, __LINE__, &vars[2], memory_order_acquire);
  ...
  int v15 = (v4_r5 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_1, v15, memory_order_release);
  int v16 = (v8_r7 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r7_0, v16, memory_order_release);
