...
label_1:;
  ...
  int v18 = (v4_r6 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_0_r6_1, v18, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(__LINE__, __LINE__, &atom_0_r6_1, memory_order_acquire);
