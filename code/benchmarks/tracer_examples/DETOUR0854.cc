...
lbl_LC00:;
  ...
  int v19 = (v6_r5 == 4);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r5_4, v19, memory_order_release);
  int v20 = (v9_r6 == 0);
...
int user_main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_3, memory_order_acquire);
  int v12 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r5_4, memory_order_acquire);
