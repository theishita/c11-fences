...
label_2:;
  ...
  int v25 = (v4_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_1_r3_0, v25, memory_order_release);
...
label_3:;
  ...
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v6_r3 = atomic_load_explicit(__LINE__, __LINE__, &vars[3], memory_order_acquire);
  int v26 = (v6_r3 == 0);
...
label_5:;
  ...
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  atomic_store_explicit(__LINE__, __LINE__, &vars[5], 1, memory_order_release);
  int v27 = (v8_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_4_r1_1, v27, memory_order_release);

}

void t5(void *arg){
label_6:;
  int v10_r1 = atomic_load_explicit(__LINE__, __LINE__, &vars[5], memory_order_acquire);
  atomic_fetch_add_explicit(__LINE__, __LINE__, &__fence_var, 0, memory_order_acq_rel);
  int v12_r3 = atomic_load_explicit(__LINE__, __LINE__, &vars[0], memory_order_acquire);
  int v28 = (v10_r1 == 1);
  atomic_store_explicit(__LINE__, __LINE__, &atom_5_r1_1, v28, memory_order_release);
  int v29 = (v12_r3 == 0);
  atomic_store_explicit(__LINE__, __LINE__, &atom_5_r3_0, v29, memory_order_release);
...
int user_main(int argc, char **argv){
  ...
  int v14 = atomic_load_explicit(__LINE__, __LINE__, &atom_1_r3_0, memory_order_acquire);
  int v15 = atomic_load_explicit(__LINE__, __LINE__, &atom_2_r3_0, memory_order_acquire);
  int v16 = atomic_load_explicit(__LINE__, __LINE__, &atom_4_r1_1, memory_order_acquire);
  int v17 = atomic_load_explicit(__LINE__, __LINE__, &atom_5_r1_1, memory_order_acquire);
  int v18 = atomic_load_explicit(__LINE__, __LINE__, &atom_5_r3_0, memory_order_acquire);
