...
\newcommand{\ordevents}[2]{\events{#1}^{(#2)}\xspace}
\newcommand{\ordwrites}[2]{\events{#1}^\wt{(#2)}\xspace}
\newcommand{\ordreads}[2]{\events{#1}^\rd{(#2)}\xspace}
...
\newcommand{\scord}[3]{\reln{\textbf{\textcolor{Mahogany}{sc}}}{#1}{#2}{#3}\xspace} %sc

\newcommand{\setSB}{{\color{CarnationPink}\tt{sb}}\xspace}
\newcommand{\setRF}{{\color{PineGreen}\tt{rf}}\xspace}
\newcommand{\setSW}{{\color{Magenta}\tt{sw}}\xspace}
\newcommand{\setDOB}{{\color{Mulberry}\tt{dob}}\xspace}
\newcommand{\setITHB}{{\color{NavyBlue}\tt{ithb}}\xspace}
\newcommand{\setHB}{{\color{Cerulean}\tt{hb}}\xspace}
\newcommand{\setMO}{{\color{red}\tt{mo}}\xspace}
\newcommand{\setTO}{{\color{Brown}\tt{to}}\xspace}
\newcommand{\setSC}{{\color{Mahogany}\tt{sc}}\xspace}
