...
\draw [->,>=stealth,color=Magenta] (f1.north east) to[out=-165,in=-15] node[midway,above=6pt,font=\small,color=black] { $\lsw$ } node[midway,above=-1pt,font=\small,color=black] {\tt \textcolor{Sepia}{(swFF)} } (f2.north west);
