...
In the absence of $\setFR$, $\setHB$ $\union$ $\setMO$ $\union$ $\setRF$
...
\hlref{sohb} and \hlref{soFF} can be used to construct $\setSO$ edges between 
...
that could stop a buggy behavior creating a cycle in 
$\setHB \union \setRF \union \setMO$. 
This strategy may invalidate a buggy trace by introducing 
