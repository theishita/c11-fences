...
%
\begin{theorem}
	$\to{\tau}{}{}$ $\subseteq$ (transitive closure of $\so{\fx{\tau}}{}{}$)
	while if $\exists$ $\to{\im{\tau}}{}{}$ then $\to{\im{\tau}}{}{}$ = 
	(transitive closure of $\so{\fx{\tau}}{}{}$)
\end{theorem}
%
A cyclic $\so{\fx{\tau}}{}{}$ implies that there does not exist a 
