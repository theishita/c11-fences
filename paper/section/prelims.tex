...
\noindent
{\bf Buggy and invalidated executions}: A \deleted{ threads of} 
...
assert check (\ie the condition in the assert check computes} \added{evaluates} to
{\em false}. \deleted{is called a buggy trace.}


\comment{This is not the place for the paragraph}The purpose of this work 
